...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  10, 40 }, { 294,  40 }, { 294, 310 }, { 10, 310 } }
   ...
   */
  #define TRAMMING_SCREW_THREAD M4_CCW
 ...
 */
  ...
  #define MESH_MAX_X X_BED_SIZE - (MESH_INSET) - PROBE_OFFSET_X_AXIS
  #define MESH_MAX_Y Y_BED_SIZE - (MESH_INSET) - PROBE_OFFSET_Y_AXIS
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH        45
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE     1
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     35
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE          1
